        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: `© desarollado por Emilio Custodio | 2022`, iconURL: `https://lh3.googleusercontent.com/sZ1VxXPigpCDhByRG3EeM0c4iFDVA7pwdifeu4E39K2IaMWqGn4Xr2JZ-Fp_-0m9UT4_=s92` })
                    .setColor("0003FF");
                //condicionales
            ...
            .setColor("0003FF")
            .setDescription(`Bot Multifuncional en Desarollo por \`EmiBOT\``)
            ...
            .addField(`📈 **__ESTADÍSTICAS__**`, `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 Desarollado por **[EmiBOT#2446](https://discord.gg/E272Ns3JjT)**`)
            .addField(`✍ **__CÓDIGO PÚBLICO__**`, `[\`DESCARGA EL CÓDIGO GRATIS!\`](https://github.com/EMIGENIO/EmiBOT)`)
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarollado por Emilio Custodio | 2022`, iconURL: `https://lh3.googleusercontent.com/sZ1VxXPigpCDhByRG3EeM0c4iFDVA7pwdifeu4E39K2IaMWqGn4Xr2JZ-Fp_-0m9UT4_=s92` })
